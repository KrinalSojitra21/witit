...
const EditGenerationPostPrompt = ({
  ...
  return (
    <CustomDialog
      ...
      className="w-full max-h-[610px] flex flex-col gap-2    justify-start items-center"
    >
      ...
      />
      <form className="h-full w-full flex p-5 gap-10">
        {step === 0 && (
          <>
            <div className=" h-full  w-[40%] ">
              <div className="relative  max-h-[500px] h-full   w-[340px] overflow-hidden object-cover rounded-lg">
            ...
            <div className=" w-[60%]  flex flex-col justify-between">
              <div className=" flex flex-col text-blue-main">
                ...
                <div className="flex w-full justify-between items-center py-5 border-b border-grey-500">
                ...
                {defaultValues?.promptDetails?.allowPromptView && (
                  <div className="w-full  flex justify-between items-center py-5 gap-5">
                    ...
                    <input
                      ...
                      placeholder="0"
                      className=" w-[80px] p-2 text-center border  rounded-md focus:outline-none border-grey-600 bg-grey-800 py-2"
                    />
                  </div>
                )}
              </div>
